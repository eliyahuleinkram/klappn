...
function SaltShaker() {
  // Machined, not clip-art (user 07-27): the cap is TURNED steel (a real
  // gradient, a specular sliver), the glass carries light down its body, the
  // salt bed has depth, and the rim wears one kiss of the brand pink — the
  // only color in the room that isn't light.
  return (
    <svg viewBox="0 0 24 24" className="h-7 w-7" aria-hidden>
      <defs>
        <linearGradient id="zsCap" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#f2f4f8" />
          <stop offset="0.45" stopColor="#c3c7d1" />
          <stop offset="1" stopColor="#8b8f9c" />
        </linearGradient>
        <linearGradient id="zsGlass" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="rgba(255,255,255,0.16)" />
          <stop offset="0.55" stopColor="rgba(255,255,255,0.05)" />
          <stop offset="1" stopColor="rgba(255,255,255,0.12)" />
        </linearGradient>
        <linearGradient id="zsSalt" x1="0" y1="0" x2="0" y2="1">
