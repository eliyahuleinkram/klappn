...
osc(8, 0.11, 0.9)
  ...
  .modulateScale(osc(3, 0.04), 0.12)
  .blend(src(o0).scale(1.012).rotate(0.004).brightness(-0.025), 0.42)
...
osc(2.2, 0.05, 0.8)
  .color(1.0, 0.68, 0.35)
  .modulate(noise(1.6, 0.06), 0.16)
  .modulate(src(o0).scale(1.02), 0.06)
  .diff(shape(3, 0.35, 0.7).color(0.4, 0.16, 0.1).rotate(H(sine.range(-0.35, 0.35).slow(14))).scale(H(sine.range(0.9, 1.25).slow(10))))
  .add(noise(3, 0.2).thresh(0.72, 0.02).color(1.0, 0.8, 0.5), 0.05)
  .blend(src(o0).scale(1.004).brightness(-0.02), 0.3)
  .brightness(0.05)
  .contrast(1.12)
  .saturate(vSaturation).contrast(vContrast).brightness(vBrightness).hue(vHue).out()
*/
...
osc(4, 0.05, 0.85)
  ...
  .modulateScale(osc(1.6, 0.015), 0.14)
  .mult(voronoi(3, 0.35, 0.25).color(0.45, 0.85, 0.95).brightness(0.18), 0.6)
  .blend(src(o0).scrollY(0.0025).scale(1.006).brightness(-0.015), 0.38)
...
voronoi(9, 0.22, 0.5)
  ...
  .modulateScale(noise(1.2, 0.03), 0.08)
  .diff(osc(6, 0.07, 0.5).color(0.5, 0.2, 0.05).rotate(H(saw.range(0, 6.283).slow(28))))
  .add(shape(2, 0.004, 0.4).color(1.0, 0.65, 0.25).rotate(0.35).scrollX(H(saw.range(-0.6, 0.6).slow(12))), 0.22)
  .blend(src(o0).scale(1.006).brightness(-0.02), 0.35)
  .brightness(0.03)
  .contrast(1.22)
  .saturate(vSaturation).contrast(vContrast).brightness(vBrightness).hue(vHue).out()
*/
...
const vHue = 0
shape(5, 0.28, 0.9)
  .color(0.45, 0.18, 0.62)
  .kaleid(5)
  .scale(H(sine.range(0.78, 1.22).slow(12)))
  .modulate(noise(1.4, 0.04), 0.22)
  .modulateRotate(src(o0), 0.06)
  .mult(osc(3, 0.025, 0.7).color(0.62, 0.3, 0.85))
  .blend(src(o0).scale(1.008).rotate(-0.003).brightness(-0.03), 0.45)
  .contrast(1.32)
  .brightness(-0.02)
  .saturate(vSaturation).contrast(vContrast).brightness(vBrightness).hue(vHue).out()
*/
...
shape(32, 0.14, 0.6)
  .color(1.0, 0.72, 0.4)
  .scrollY(H(saw.range(0.5, -0.5).slow(26)))
  .add(shape(32, 0.07, 0.5).color(0.95, 0.45, 0.65).scrollY(H(saw.range(0.7, -0.5).slow(34))).scrollX(0.26), 0.85)
  .add(shape(32, 0.04, 0.45).color(0.55, 0.6, 1.0).scrollY(H(saw.range(0.9, -0.6).slow(44))).scrollX(-0.22), 0.7)
  .modulate(noise(0.8, 0.025), 0.06)
  .blend(src(o0).scrollY(-0.004).scale(1.003).brightness(-0.012), 0.5)
  .brightness(0.02)
  .saturate(vSaturation).contrast(vContrast).brightness(vBrightness).hue(vHue).out()
*/
$strudel$, 'ready', 8, 'loop'),
